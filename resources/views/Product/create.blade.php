...
<ol class="breadcrumb breadcrumb-col-blue pull-right">
    ...
    <li class="active"><i class="material-icons">add</i> New Product</li>
</ol>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-blue">
							 <h2><strong>Add New Product's Details here:</strong></h2>
                            ...
                            <form action="{{ url('/products/new') }}" method="post" enctype="multipart/form-data">
  							@csrf
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control  {{ $errors->has('prod_name') ? ' is-invalid' : '' }}" name="prod_name" value="{{ $errors->has('prod_name') ? '' : old('prod_name') }}" placeholder="Product Name">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea class="form-control {{ $errors->has('prod_description') ? ' is-invalid' : '' }}" value="{{ $errors->has('prod_description') ? '' : old('prod_description') }}" name="prod_description" placeholder="Product Description"></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" class="form-control {{ $errors->has('prod_price') ? ' is-invalid' : '' }}" name="prod_price" placeholder="Product Price" value="{{ $errors->has('prod_price') ? '' : old('prod_price') }}">
                                    </div>
